...
\begin{document}
   ...
   \section{Neural basis of self}
      The self is grounded in self-referential processing, through which the brain distinguishes stimuli related to one's own person from non-self-related stimuli. Neuroimaging evidence suggests that self-referential processing is associated particularly with cortical midline structures, providing a neural basis for the representation and processing of the self. From the neurological perspective , the self is recognized through self-referential processing, particularly involving cortical midline structures.
      \cite{northoff-2006-self-referential-processing-in-our-brain-a-meta-analysis-of-imaging-studies-on-the-self}.


      \seehere{https://en.wikipedia.org/wiki/Neural_basis_of_self}

   \section{From autobiographical memory}
      In \cite{brewer-1986-what-is-autobiographical-memory} page 26, the parts of self is mentioned and is summarized as the working self, often referred to as just the 'self', is a set of active personal goals or self-images organized into goal hierarchies. These personal goals and self-images work together to modify cognition and the resulting behavior so an individual can operate effectively in the world.
   ...
   \section{Determining self boundries}
