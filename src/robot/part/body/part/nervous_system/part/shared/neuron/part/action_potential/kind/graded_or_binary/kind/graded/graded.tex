...
\begin{document}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{/home/donkarlo/Dropbox/repo/nd_robotic_ai_learning_project/src/robot/part/body/part/nervous_system/action_potential/graded_or_binary/kind/graded_potential/graded_potential.png}
    \end{figure}
