...
\title{Population code}
\date{}
\author{Mohammad Rahmani}

\begin{document}
    \maketitle
    Population coding is a method to represent stimuli by using the joint activities of a number of neurons. In population coding, each neuron has a distribution of responses over some set of inputs, and the responses of many neurons may be combined to determine some value about the inputs \seeherefooter{https://en.wikipedia.org/wiki/Neural\_coding#Population\_coding}.
    ...
    \seeherefooter{https://en.wikipedia.org/wiki/Neural\_coding#Population\_coding}
